...
TABLE_NAME = "Questionaire_questions"
PROFILE_NAME = "rfp-infra"
REGION_NAME = "us-east-1"

# Key schema:
#   questionaire_id -> partition key (HASH)
#   question_id     -> sort key (RANGE)
#
# Regular attributes (no pre-declaration needed in DynamoDB):
#   question_text, question_type, allowed_answers, mandatory_ind,
#   evidence_required, topic


def create_questionaire_questions_table():
...
if __name__ == "__main__":
    create_questionaire_questions_table()
